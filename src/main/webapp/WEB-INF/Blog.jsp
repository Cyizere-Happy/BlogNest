...
<main class="container">
    ...
    <section class="intro-section">
        <h2 class="intro-title">HI, I'm <span>Cyizere</span></h2>
        <p class="intro-desc">
        ...
        <div class="intro-actions">
            <a href="${pageContext.request.contextPath}/Blogs" class="btn btn-primary">Explore my thoughts</a>
            <a href="https://happy4ward.vercel.app" target="_blank" class="btn btn-secondary">View my portfolio</a>
        </div>
    </section>
</main>
